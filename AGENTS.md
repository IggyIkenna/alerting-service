# AGENTS.md — alerting-service

## Quick Reference for AI Agents

### Key Commands

- **Quality gates**: `cd alerting-service && bash scripts/quality-gates.sh`
- **Source dir**: `alerting-service/alerting_service/` (underscored)
- **Typecheck**: `run_timeout 120 basedpyright alerting_service/`
